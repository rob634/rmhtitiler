...
- [custom_pgstac_main.py](custom_pgstac_main.py) - Complete FastAPI application with:
  - OAuth authentication (copied from rmhtitiler v2.0.0)
...
## Differences from rmhtitiler

| Aspect | rmhtitiler | titilerpgstac |
|--------|-----------|---------------|
...
- **OAuth Reference**: rmhtitiler/custom_main.py
...
**OAuth Code**: Production-validated from rmhtitiler v2.0.0
