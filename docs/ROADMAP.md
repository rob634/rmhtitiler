...
- [ ] Build new Docker image: `rmhtitiler:2.0.0-oauth`
...
az acr build --registry rmhacr --image rmhtitiler:2.0.0-oauth .

# Update App Service
az webapp config container set \
  --name rmhtitiler-ghcyd7g0bxdvc2hc \
  --resource-group rmhgeography \
  --docker-custom-image-name rmhacr.azurecr.io/rmhtitiler:2.0.0-oauth

# Monitor deployment
az webapp log tail --name rmhtitiler-ghcyd7g0bxdvc2hc --resource-group rmhgeography
```
...
#### 2.1 Project Setup
- [ ] Create new project directory: `rmhtitiler-pgstac/`
