...
# ============================================================================
"""
Structured Logging System for rmhtitiler.
...
Global Log Context:
    ...
    This enables filtering logs in multi-app deployments:
        traces | where customDimensions.app_name == "rmhtitiler"
...
class LoggerFactory:
    ...
    def create_logger(
        ...
        logger_name = f"rmhtitiler.{component.value}.{name}"
        ...
        def record_factory(*args, **kwargs):
            ...
            if record.name.startswith(f"rmhtitiler.{component.value}"):
