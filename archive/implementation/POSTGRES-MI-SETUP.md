...
# Build Docker image
docker build -t geotiler:latest .

# Push to Azure Container Registry (or your registry)
az acr login --name <your-registry>
docker tag geotiler:latest <your-registry>.azurecr.io/geotiler:latest
docker push <your-registry>.azurecr.io/geotiler:latest
...
curl https://geotiler.azurewebsites.net/collections | jq
