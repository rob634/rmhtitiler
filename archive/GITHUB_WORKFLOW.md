...
**Repository**: https://github.com/rob634/geotiler
**Status**: Public
...
```
Dev Mac (VS Code) → GitHub (rob634/geotiler) → Work Laptop (VS Code) → Corporate ACR → Corporate Azure
```
...
# Should show:
# origin  https://github.com/rob634/geotiler.git (fetch)
# origin  https://github.com/rob634/geotiler.git (push)
```

If not configured:
```bash
git remote add origin https://github.com/rob634/geotiler.git
```
...
# Clone repo
git clone https://github.com/rob634/geotiler.git
cd geotiler
