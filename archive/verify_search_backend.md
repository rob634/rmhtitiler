...
curl -X POST "https://geotiler-ghcyd7g0bxdvc2hc.eastus-01.azurewebsites.net/searches/register" \
...
SEARCH_ID=$(curl -s -X POST "https://geotiler-.../searches/register" \
  -H "Content-Type: application/json" \
...
# 2. Verify it works
curl "https://geotiler-.../searches/$SEARCH_ID/info" | jq
